    ...
    def __init__(self, local=True, user='root', password='****', host='localhost',
        ...
        self.table_template.update({'statistics_table_status':
                       lambda x:( "CREATE TABLE `%s` ("
                         ...
                         ") ENGINE=InnoDB")%x,})
        #TODO, NEED TO FIX IT HERE Total_Day....
        self.statistics_type_indentifier = {'user_statistics_day': (24,'h','Total_Day'),
                                            'user_statistics_week': (7,'d','Total_Week'),
                                            'user_statistics_year': (52,'w','Total_Year')}
